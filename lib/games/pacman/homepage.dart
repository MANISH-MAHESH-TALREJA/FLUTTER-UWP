            ...
            child: GestureDetector(
              ...
              child: GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      childAspectRatio: MediaQuery.of(context).size.aspectRatio*1.43,
                  ...
                  itemBuilder: (BuildContext context, int index)
                  {
                    ...
                    {
                      return MyPixel(innerColor: Colors.blue[800]!, outerColor: Colors.blue[900]!, child: const Text(''),);
                    }
                    else if(!barriers.contains(index) && vis.contains(index))
                    {
                      return MyPath(innerColor: Colors.black, outerColor: Colors.black, child: const Text(''),);
                    }
                    else
                    {
                      return MyPath(innerColor: Colors.yellow[400]!, outerColor: Colors.black, child: const Text(''),);
                    }
                  }),
            ),
          ),
