...
class OverlaySurface extends CustomPainter
{
  ...
  OverlaySurface({required this.clickOffset, required this.selectedHomeIndex, required this.highlightColor});
  ...
  void paint(Canvas canvas, Size size)
  {
    ...
    var home = const Rect.fromLTWH(0, 0, 0, 0);
    switch (selectedHomeIndex)
    {
      ...
      case 1:
       home = Rect.fromLTWH(homeStartOffset, 0, homeSize, homeSize);
        break;
      case 2:
        home = Rect.fromLTWH(homeStartOffset, homeStartOffset, homeSize, homeSize);
        break;
      default:
