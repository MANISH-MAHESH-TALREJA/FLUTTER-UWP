...
class BoardPainter extends CustomPainter
{
  ...
  double _stepSize = 0.0, _homeStartOffset = 0.0, _homeSize = 0.0, _canvasCenter = 0.0;
  ...
  {
    Rect prevRect = const Rect.fromLTRB( 0.0, 0.0, 0.0, 0.0 );
    Offset prevOffset = const Offset(0.0,0.0);
    ...
    for (int stepIndex = 0; stepIndex < 57; stepIndex++)
    {
      ...
      else if (stepIndex < 5 || stepIndex > 50 || stepIndex > 18 && stepIndex < 24 || stepIndex > 10 && stepIndex < 13)
      {
        prevOffset = Offset(prevRect.center.dx + _stepSize, prevRect.center.dy);
      }
      else if (stepIndex == 5)
      {
        prevOffset = Offset(prevRect.center.dx + _stepSize, prevRect.center.dy - _stepSize);
      }
      else if (stepIndex < 11 || stepIndex > 38 && stepIndex < 44 || stepIndex == 50)
      {
        prevOffset = Offset(prevRect.center.dx, prevRect.center.dy - _stepSize);
      }
      else if (stepIndex < 18 || stepIndex > 31 && stepIndex < 37 || stepIndex > 18 && stepIndex < 26)
      {
        prevOffset = Offset(prevRect.center.dx, prevRect.center.dy + _stepSize);
      }
      ...
      else if (stepIndex < 31 || stepIndex > 31 && stepIndex < 39 || stepIndex > 44 && stepIndex < 50)
      {
        prevOffset = Offset(prevRect.center.dx - _stepSize, prevRect.center.dy);
      }
      ...
      prevRect = Rect.fromCenter(center: prevOffset, width: _stepSize, height: _stepSize);
    ...
    playerTwoTrack.add(Rect.fromCenter(center: Offset(prevRect.center.dx, prevRect.center.dy - _stepSize), width: _stepSize, height: _stepSize));
    ...
    playerThreeTrack.add(Rect.fromCenter(center: Offset(prevRect.center.dx + _stepSize, prevRect.center.dy), width: _stepSize, height: _stepSize)
    );
    ...
    playerFourTrack.add(Rect.fromCenter(center: Offset(prevRect.center.dx, prevRect.center.dy + _stepSize), width: _stepSize, height: _stepSize));
  ...
  void _drawHome(Canvas canvas, Size size)
  {
    ...
    var home3 = Rect.fromLTWH(_homeStartOffset, _homeStartOffset, _homeSize, _homeSize);
    ...
    var innerHome1 = Rect.fromLTWH(home1.left + _stepSize, home1.top + _stepSize, innerHomeSize, innerHomeSize);
    canvas.drawRect(innerHome1, _fillPaint);
    canvas.drawRect(innerHome1, _strokePaint);

    var innerHome2 = Rect.fromLTWH(home2.left + _stepSize, home2.top + _stepSize, innerHomeSize, innerHomeSize);
    canvas.drawRect(innerHome2, _fillPaint);
    canvas.drawRect(innerHome2, _strokePaint);

    var innerHome3 = Rect.fromLTWH(home3.left + _stepSize, home3.top + _stepSize, innerHomeSize, innerHomeSize);
    canvas.drawRect(innerHome3, _fillPaint);
    canvas.drawRect(innerHome3, _strokePaint);

    var innerHome4 = Rect.fromLTWH(home4.left + _stepSize, home4.top + _stepSize, innerHomeSize, innerHomeSize);
  ...
  void _drawSteps(Canvas canvas, Size size)
  {
    ...
    for (int homeIndex = 0; homeIndex < 4; homeIndex++)
    {
      ...
      {
        var unit = Rect.fromLTWH(pos * _stepSize, verticalOffset, _stepSize, _stepSize);
